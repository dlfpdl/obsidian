...
- 소모임, 즉 콘텐츠를 어떻게 뾰족하게 만들 수 있을까.
	...
	- 더 뾰족하게.
	- 더 큰 가치를.
	- 결국 **==오퍼레이션==**. **고객에게 감동을 줄 수 있는** A-Z 브레인스토밍이 됨. “오프라인 소셜살롱의 고민” = **오퍼레이션의 고도화**. 정말 뾰족한 설계가 필요하다.
	- **고객**에 대한 정의가 더 뾰족해야 한다.
		- **고객**과 **가치**에 대해서 더 뾰족해야만 한다.
	- **재무설계**: Stream Cost < Revenue (이것 떄문에 망하는 회사가 있음)
		- **재무현황에 대한 보고서** 또한 “다음 미팅부터” 필요할 것.
	- **Content**: 유저풀을 확보하고 있는 기업 또는 인플루언서의 니즈를 채워주는 콘텐츠 기획. (맵, 캐릭터, 기능 등)
	- **고민**: “우리 모든 팀원 일이 처음이다. 보고서는 어떻게 써야 하고, 일은 어떻게 해야 하는지.”